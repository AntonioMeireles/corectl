...
const latestImageBreackage = "2016-06-22T18:45:00WET"
...
var (
	...
	CoreOEMsetup          = assets.Contents("target/coreos/corectl.yml")
	CoreOEMsetupEnv       = assets.Contents("target/coreos/coreos-setup-environment")
)
